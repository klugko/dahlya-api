...
class CVFile(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id"), nullable=True) # Reste nullable pour les uploads anonymes
    ...
    owner = relationship("User", back_populates="cv_files") # Utilise back_populates pour une relation bidirectionnelle
